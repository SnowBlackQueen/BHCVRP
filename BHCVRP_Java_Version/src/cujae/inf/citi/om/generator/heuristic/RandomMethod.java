...
/* Clase que modela un m�todo de construcci�n de forma aleatoria*/
...
public class RandomMethod extends Heuristic{
	...
	public Solution getSolutionInicial() {
		...
		switch(Problem.getProblem().getTypeProblem().ordinal())
		{
			...
			case 4:
			{
				...
				while(!CustomersToVisit.isEmpty()) // condici�n de cant veh
				{
					customer = getRandomCustomer(CustomersToVisit);
	...
	/* M�todo que devuelve un cliente de la lista de forma aleatoria */
