...
def main(self):
    try:
        ...
        load_file.load_customers_ttrp(id_customers, axis_x_customers, axis_y_customers, request_customers, type_customers)
        load_file.load_depots_ttrp(id_depots, axis_x_depots, axis_y_depots)
