from cujae_inf_citi_om.data import CustomerType
from cujae_inf_citi_om.data import Problem
from solution import Route, RouteType
from typing import List, Tuple

class RouteTTRP(Route):
    def __init__(self, list_id_customers=None, request_route=None, cost_route=None, id_depot=None, list_access_vc=None, type_route=None):
        super().__init__(list_id_customers, request_route, cost_route, id_depot, list_access_vc)
